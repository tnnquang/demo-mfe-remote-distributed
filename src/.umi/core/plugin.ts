...
import * as Plugin_1 from 'D:/Project/mfe-demo/demo-mfe-remote-distributed/src/.umi/plugin-model/runtime.tsx';
...
export function getPlugins() {
  return [
    ...
    {
      apply: Plugin_1,
      path: process.env.NODE_ENV === 'production' ? void 0 : 'D:/Project/mfe-demo/demo-mfe-remote-distributed/src/.umi/plugin-model/runtime.tsx',
    },
  ];
}
