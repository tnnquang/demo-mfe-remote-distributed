...
import * as Plugin_1 from 'C:/Project/personal/mfe-demo/remote-distributed/src/.umi/plugin-model/runtime.tsx';
...
export function getPlugins() {
  return [
    ...
    {
      apply: Plugin_1,
      path: process.env.NODE_ENV === 'production' ? void 0 : 'C:/Project/personal/mfe-demo/remote-distributed/src/.umi/plugin-model/runtime.tsx',
    },
  ];
}
